...
@property(strong, nonatomic)NSMutableDictionary * imagesPlanetas; //Se declara el arreglo globarl e inmutable,
@property(strong, nonatomic)NSMutableDictionary * descripcion;
